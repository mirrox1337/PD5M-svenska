...
if ActivateClothMarkers then
	...
	CreateThread(function()
		while true do
			for i,coord in ipairs(list_cloth_coords) do
				...
				if distance < 5 then
					atcloth = true
					StartHelpNotify('Tryck ~INPUT_CONTEXT~ för att öppna ~b~Garderoben~s~ (MP-karaktär Krävs).', 500)
					Wait(40)
					while distance < 5 do
						HelpNotify('Tryck ~INPUT_CONTEXT~ för att öppna ~b~Garderoben~s~ (MP-karaktär Krävs).', 500)
						Wait(500)
						local player_x, player_y, player_z = table.unpack(GetEntityCoords(PlayerPedId(), false))
						distance = Vdist2(coord.x, coord.y, coord.z, player_x, player_y, player_z)
					end
					EndHelpNotify('Tryck ~INPUT_CONTEXT~ för att öppna ~b~Garderoben~s~ (MP-karaktär Krävs).', 500)
					atcloth = false
				end
			end
		Wait(1000)
	...
	CreateThread(function()
		...
		WarMenu.CreateMenu('Umkleide', 'Garderoben')
		WarMenu.CreateSubMenu('AllgemeinCloth', 'Umkleide', 'Allmämt')
		WarMenu.CreateSubMenu('Gürtel', 'AllgemeinCloth', 'Bälten')
		WarMenu.CreateSubMenu('Rangabzeichen', 'AllgemeinCloth', 'Rank Insignia')
		WarMenu.CreateSubMenu('Kopfbedeckungen', 'AllgemeinCloth', 'Huvudbonader')
		WarMenu.CreateSubMenu('Brillen', 'AllgemeinCloth', 'Glasögon')
		WarMenu.CreateSubMenu('Balaclavas', 'AllgemeinCloth', 'Balaclavas')

		WarMenu.CreateSubMenu('UndressCloth', 'AllgemeinCloth', 'Klä Av')

		WarMenu.CreateSubMenu('LSPDCloth', 'Umkleide', 'LSPD-Uniform')
		WarMenu.CreateSubMenu('LSPDTops', 'LSPDCloth', 'LSPD-Toppar')
		WarMenu.CreateSubMenu('LSPDHose', 'LSPDCloth', 'LSPD-Byxor')
		WarMenu.CreateSubMenu('LSPDShoes', 'LSPDCloth', 'LSPD-Skor')

		WarMenu.CreateSubMenu('BCSOCloth', 'Umkleide', 'BCSO-Uniform')
		WarMenu.CreateSubMenu('BCSOTops', 'BCSOCloth', 'BCSO-Toppar')
		WarMenu.CreateSubMenu('BCSOHose', 'BCSOCloth', 'BCSO-Byxor')
		WarMenu.CreateSubMenu('BCSOShoes', 'BCSOCloth', 'BCSO-Skor')

		WarMenu.CreateSubMenu('SAPRCloth', 'Umkleide', 'SAPR-Uniform')
		WarMenu.CreateSubMenu('SAPRTops', 'SAPRCloth', 'SAPR-Toppar')
		WarMenu.CreateSubMenu('SAPRHose', 'SAPRCloth', 'SAPR-Byxor')
		WarMenu.CreateSubMenu('SAPRShoes', 'SAPRCloth', 'SAPR-Skor')

		WarMenu.CreateSubMenu('SASPCloth', 'Umkleide', 'SASP-Uniform')
		WarMenu.CreateSubMenu('SASPTops', 'SASPCloth', 'SASP-Toppar')
		WarMenu.CreateSubMenu('SASPHose', 'SASPCloth', 'SASP-Byxor')
		WarMenu.CreateSubMenu('SASPShoes', 'SASPCloth', 'SASP-Skor')

		WarMenu.CreateSubMenu('SWATCloth', 'Umkleide', 'SWAT-Uniform')
		WarMenu.CreateSubMenu('SWATTops', 'SWATCloth', 'SWAT-Toppar')
		WarMenu.CreateSubMenu('SWATHose', 'SWATCloth', 'SWAT-Byxor')
		WarMenu.CreateSubMenu('SWATShoes', 'SWATCloth', 'SWAT-Skor')

		WarMenu.CreateSubMenu('DPOSCloth', 'Umkleide', 'DPOS-Uniform')
		WarMenu.CreateSubMenu('DPOSTops', 'DPOSCloth', 'DPOS-Toppar')
		WarMenu.CreateSubMenu('DPOSHose', 'DPOSCloth', 'DPOS-Byxor')
		WarMenu.CreateSubMenu('DPOSShoes', 'DPOSCloth', 'DPOS-Skor')

		WarMenu.CreateSubMenu('SheriffCloth', 'Umkleide', 'Sheriff-Uniform')
		WarMenu.CreateSubMenu('SheriffTops', 'SheriffCloth', 'Sheriff-Toppar')
		WarMenu.CreateSubMenu('SheriffHose', 'SheriffCloth', 'Sheriff-Byxor')
		WarMenu.CreateSubMenu('SheriffShoes', 'SheriffCloth', 'Sheriff-Skor')
		WarMenu.CreateSubMenu('SheriffAccess', 'SheriffCloth', 'Sheriff-Tillbehör')
		WarMenu.CreateSubMenu('SheriffDecals', 'SheriffCloth', 'Sheriff-Dekaler')
		WarMenu.CreateSubMenu('SheriffHead', 'SheriffCloth', 'Sheriff-Huvudbonad')
		...
		while true do
			...
			elseif WarMenu.IsMenuOpened('LSPDCloth') then
				if WarMenu.MenuButton('Toppar', 'LSPDTops') then
				elseif WarMenu.MenuButton('Byxor', 'LSPDHose') then
				elseif WarMenu.MenuButton('Skor', 'LSPDShoes') then
				elseif WarMenu.MenuButton('Tillbaka', 'Umkleide') then
				end
			WarMenu.Display()
			elseif WarMenu.IsMenuOpened('LSPDTops') then
				if WarMenu.Button('LSPD-Skjorta') then
				...
				elseif WarMenu.Button('Skjorta') then
					if GetEntityModel(GetPlayerPed(-1)) == GetHashKey('mp_m_freemode_01') then
				...
				elseif WarMenu.MenuButton('Tillbaka', 'LSPDCloth') then
				end
			WarMenu.Display()
			...
			elseif WarMenu.IsMenuOpened('AllgemeinCloth') then
				if WarMenu.MenuButton('Bälten', 'Gürtel') then
				elseif WarMenu.MenuButton('Rank Insignia', 'Rangabzeichen') then
				elseif WarMenu.MenuButton('Huvudbonad', 'Kopfbedeckungen') then
				elseif WarMenu.MenuButton('Balaclavas', 'Balaclavas') then
				elseif WarMenu.MenuButton('Glasögon', 'Brillen') then
				elseif WarMenu.MenuButton('Klä av', 'UndressCloth') then
				elseif WarMenu.MenuButton('Tillbaka', 'Umkleide') then
				end
			WarMenu.Display()
			elseif WarMenu.IsMenuOpened('Gürtel') then
				if WarMenu.Button('Inget') then
					if GetEntityModel(GetPlayerPed(-1)) == GetHashKey('mp_m_freemode_01') then
